...
nohup java -jar -Dspring.profiles.active=local -Duser.timezone=Asia/Seoul $DEPLOY_JAR --server.port=8080 >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
